...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        .to(tapeGroup.rotation, 4, {y:-4.75,x:4}, 2.5) //rotation cassette sur elle meme
        ...
        .to(tapeGroup.position, 2, {x:8.560792922973633,y:8.795806884765625,z:-13}, 4) //rotation cassette sur elle meme
