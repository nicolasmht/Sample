...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        let wheelsR = tape.getObjectByName('Wheel_right')
             ...
             let case_closedmobj1 = tape.getObjectByName('case_closed-mobj1')
             let case_tape = tape.getObjectByName('case_tape')

             let Case_b_Case_b_elem = tape.getObjectByName('Case_b_Case_b_elem')
             let Case_t_Case_t_elem = tape.getObjectByName('Case_t_Case_t_elem')
        ...
        .to(case_closedmobj1.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(case_tape.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(Case_b_Case_b_elem.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(Case_t_Case_t_elem.material, .5, {opacity: 0},0.15) //degage case opacity
