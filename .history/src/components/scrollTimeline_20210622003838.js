...
function ScrollTimeline(scene, camera) {
        ...
        loader.load( TapeModel, ( gltf ) => {
            ...
            tape.traverse( (child) => {
                ...
                switch(modelPart) {
                    ...
                    case 'desk_haut2':
                    case 'desk_haut3':
                        child.material = new THREE.MeshBasicMaterial({color:0xetextureCLoadfb0, map: textureCaseLoad, side:THREE.DoubleSide});
                    break;
                    case 'Tape_obj':
    ...
    function initTimeline() {
        ...
        // sticker.material.depthTest = false;
        // sticker.material.depthWrite = false;
        // sticker.frustumCulled = false;
        // tape.frustumCulled = false;
        // tapeGroup.frustumCulled = false;
