...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        let AA = textureLoader.load(textureA)
        let BB = textureLoader.load(textureB)
        ...
        .add(()=> { uniforms.texture1.value = AA },1.75) //blue
        .add(()=> { uniforms.texture2.value = BB },1.75) //cyan
        ...
        .add(()=> { uniforms.texture2.value = BB },2.35) //cyan
        ...
        .add(()=> { uniforms.texture2.value = BB },2.9) //cyan
