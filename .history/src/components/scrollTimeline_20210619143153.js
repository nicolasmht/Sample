...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        console.log('HOLALALAL', tapeGroup.position);
        ...
        .to(tapeGroup.position, 1, {z: -17}, 0.35) //decalage cassette
        .to(tapeGroup.position, 1, {y:1}, 0.5) //decalage cassette
        .to(tapeGroup.rotation, 1, {x: -2, y:1}, 0.5) //bascule cassette
        .to(storage.position, 1, {y: 40}, .75) //etagere disapear
        .to(facade.position, 1, {y: 50}, .75) //etagere disapear
        .to(tapeGroup.position, 1, {x: 0,y:10, z:0}, .75) //decalage cassette
        ...
        .to(tapeGroup.position, 1, {x:8.560792922973633,y:0.75,z:-13}, 5) //rotation cassette sur elle meme
        ...
        .to(tapeGroup.position, 1, {x:8.560792922973633,y:8.795806884765625,z:0.01319566648453474}, 6) //rotation cassette sur elle meme
