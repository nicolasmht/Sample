...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    // scene.add(light);
       //PointLight
       let pointLight = new THREE.PointLight( 0x0ae0ff, 0, 20 );
    ...
    loader.load( daftPunkModel, ( gltf ) => {
            ...
            console.log('PYRAMID', pyramid.material)

            pyramid.traverse( (child) => {
                console.log(child.name)
                // if(child.name ==  'Pyramid') {
                    // child.material = new THREE.MeshStandardMaterial({map: textureColor});
                // }
            });
    ...
    function initInteraction() {
        ...
        // pyramid.material = new THREE.MeshStandardMaterial({map: textureColor});
