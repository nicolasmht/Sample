...
import mistTexture from '../textures/mist.jpg';
...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    // const matPlane = new THREE.MeshStandardMaterial( {color: 0xeeeeee, metalness: 0, roughness: 0.5,transparent: true, opacity: .5, map:texture, side: THREE.DoubleSide} );
    const matPlane = new THREE.MeshPhongMaterial( {color: 0xeeeeee, shininess: 50, specular: 0x999999 ,transparent: true, opacity: .5, map:texture, side: THREE.DoubleSide} );
    ...
    groundMirror.position.y = -23
    scene.add( groundMirror );

    // const cubeRenderTarget = new THREE.WebGLCubeRenderTarget( 128, { format: THREE.RGBFormat, generateMipmaps: true, minFilter: THREE.LinearMipmapLinearFilter
    // ,encoding:sRGBEncoding } );

    // var sphereGeom =  new THREE.SphereGeometry( 20, 22, 16 ); // radius, segmentsWidth, segmentsHeight
	// let mirrorSphereCamera = new THREE.CubeCamera( 1, 10000, cubeRenderTarget );
	...
	// mirrorSphere.position.set(0,-23,0);
	// mirrorSphere.scale.x = 3
	// mirrorSphere.scale.y = 0.1
	// mirrorSphereCamera.position.x = 5;
