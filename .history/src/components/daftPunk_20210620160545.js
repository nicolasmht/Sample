...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
	...
	let mirrorSphereCamera = new THREE.CubeCamera( 1000, 5000, cubeRenderTarget );
	// mirrorCubeCamera.renderTarget.minFilter = THREE.LinearMipMapLinearFilter;
	scene.add( mirrorSphereCamera );
	var mirrorSphereMaterial = new THREE.MeshBasicMaterial( { envMap: mirrorSphereCamera.renderTarget } );
	let mirrorSphere = new THREE.Mesh( sphereGeom, mirrorSphereMaterial );
	mirrorSphere.position.set(0,-20,0);
	mirrorSphere.scale.x = 2
	mirrorSphereCamera.position.z = 5;
