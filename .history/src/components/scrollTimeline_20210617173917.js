...
function ScrollTimeline(scene, camera) {
    ...
    function switchSoundText(date, artist, title) {
        document.querySelectorAll('.txt_slider-top .date').innerHtml = date
        document.querySelectorAll('.txt_slider-top .artist').innerHtml = artist
        document.querySelectorAll('.txt_slider-top .title').innerHtml = title

        document.querySelectorAll('.txt_slider-bot .date').innerHtml = date
        document.querySelectorAll('.txt_slider-bot .artist').innerHtml = artist
        document.querySelectorAll('.txt_slider-bot .title').innerHtml = title
    }
