...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        wheelsL.material = new THREE.MeshBasicMaterial({color:0xff0000, side:THREE.DoubleSide});
        wheelsR.material = new THREE.MeshBasicMaterial({color:0xff0000, side:THREE.DoubleSide});
        ...
        caseT.material = new THREE.MeshBasicMaterial({color:0x0000ff, transparent: true, opacity: .8, side:THREE.DoubleSide});
