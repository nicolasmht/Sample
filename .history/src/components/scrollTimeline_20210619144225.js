...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        .to(caseGrp.position, 1, {y: 40}, .65) //etagere disapear
        // .to(facade.position, 1, {y: 50}, .65) //etagere disapear
        ...
        .to(caseGrp.position, 0, {y: -30}, 2) //etagere tp bot
        // .to(facade.position, 0, {y: -30}, 2) //etagere tp bot
        //Put back
        .to(caseGrp.position, 1, {y: 0}, 5.25) //etagere appear bot
