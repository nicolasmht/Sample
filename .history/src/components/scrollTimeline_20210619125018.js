...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        //Base
        plastic.material = new THREE.MeshPhongMaterial({color:0xffff00, transparent: true, opacity: .8, side:THREE.DoubleSide});
        ...
        .to(plastic.material, .25, {color: 0xff00ff},1.5) //fade to textureB
