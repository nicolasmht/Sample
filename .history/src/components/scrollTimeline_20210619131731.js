...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        caseB.material = new THREE.MeshBasicMaterial({color:0x00ff00, transparent: true, opacity: .9, side:THREE.DoubleSide});
        caseT.material = new THREE.MeshBasicMaterial({color:0x0000ff, transparent: true, opacity: .9, side:THREE.DoubleSide});
