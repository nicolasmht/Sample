...
function ScrollTimeline(scene, camera) {
        ...
        let sound4 = new Howl({src: [soundD]});
    ...
    function switchSound() {
        ...
        sound02.once( 'fade', () => { 
            sound02.stop() 
            sound02 = new Howl({src: [soundD],volume:0})
            sound02.seek(0);
            sound02.play()
        });
        ...
        TweenLite.fromTo(document.querySelector('.slider').style, 1, {top: document.querySelector('.slider').style.top}, {top:0})
        initialPose = 0
    }
