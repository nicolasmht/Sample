...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        let DD = textureLoader.load(textureD)
        ...
        .add(()=> { uniforms.texture2.value = DD },2.9) //orange
