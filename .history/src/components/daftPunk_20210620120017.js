...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    function initInteraction() {
        ...
        let pyramidB2 = pyramid.getObjectByName('Pyramid_bas_2')//pink
        let pyramidB3 = pyramid.getObjectByName('Pyramid_bas_3')//yel
        let pyramidB4 = pyramid.getObjectByName('Pyramid_bas_4')//blue
