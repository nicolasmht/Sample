...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    const geometry = new THREE.CircleGeometry( 165, 150 );
    const material = new THREE.MeshLambertMaterial( {color: 0x111111, envMap: textureColor, reflectivity: .5, side: THREE.DoubleSide} );
