...
function ScrollTimeline(scene, camera) {
    ...
    function switchSoundText(dateT, artistT, titleT, dateB, artistB, titleB) {
        document.querySelectorAll('.txt_slider-top .date').innerHtml = dateT
        document.querySelectorAll('.txt_slider-top .artist').innerHtml = artistT
        document.querySelectorAll('.txt_slider-top .title').innerHtml = titleT

        document.querySelectorAll('.txt_slider-bot .date').innerHtml = dateB
        document.querySelectorAll('.txt_slider-bot .artist').innerHtml = artistB
        document.querySelectorAll('.txt_slider-bot .title').innerHtml = titleB
    }
