    ...
    loader.load(TapeModel,
        ...
        ( tape ) => {
            ...
            tape.traverse((element) => {
                // element.material.color = new THREE.Color('rgb(236, 217, 188)');
                element.isMesh ? element.material = material : element.material = undefined
                // element.material.map = new THREE.Color('rgb(236, 217, 188)');
                console.log('AAAAA',element.material)
                if(element.isMesh) {
                    element.material.color = new THREE.Color('rgb(36, 217, 88)')
                    element.material.emissive = new THREE.Color('rgb(193, 145, 51)')
                    // element.material.map.needsUpdate = true;
                    console.log('CCCCC',element.material)
                }
