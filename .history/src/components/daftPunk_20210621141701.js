                        ...
                        // setTimeout(()=>{
                            ...
                            switch (baseSound) {
                                case 0:
                                        ...
                                        ambiantSound4.stop();
                                        ambiantSound1 = new SoundAnalyser(context,sound0101, analyser, function (th) { th.play() })
                                        first360 = false
                                    break;
                                case 1:
                                        ...
                                        if(first360){
                                            ...
                                            ambiantSound2 = new SoundAnalyser(context,sound0201, analyser, function (th) { th.play() })
                                        }
                                        // ambiantSound2.play();
                                    break;
                                case 2:
                                        ...
                                        if(first360){
                                            ...
                                            ambiantSound3 = new SoundAnalyser(context,sound0301, analyser, function (th) { th.play() })
                                        }
                                    break;
                                case 3:
                                        ...
                                        if(first360){
                                            ...
                                            ambiantSound4 = new SoundAnalyser(context,sound0401, analyser, function (th) { th.play() })
                                        }
                                    break;
                                default:
                                    break;
