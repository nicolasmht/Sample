...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    const texture = new THREE.TextureLoader().load( 'https://i-mom.unimedias.fr/2020/09/16/pokemon-decouvrez-quel-animal-est-en-realite-pikachu.jpg' );
    const geoPlane = new THREE.CircleGeometry( 72, 100 );
    const matPlane = new THREE.MeshStandardMaterial( {color: 0xeeeeee, metalness: 0, roughness: 0.5, map:texture, side: THREE.DoubleSide} );
