...
function DaftPunk(sceneMain, cameraMain, interactionManagerMain) {
    ...
    let ambiantSound = new SoundAnalyser(context,arraySound[baseSound], analyser, function (th) {
        // this.play()
        console.log(th)
    })
    
    let ambiantSound2 = new SoundAnalyser(context,arraySound[baseSound], analyser, function () {
        // this.play()
        console.log('ihjsdbcjksdncjnsdojcnzkjbnckb')
    })
