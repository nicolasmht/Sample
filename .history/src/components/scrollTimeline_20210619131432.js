...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        caseA.material = new THREE.MeshBasicMaterial({color:0xff0000, transparent: true, opacity: .8, side:THREE.DoubleSide});
        caseB.material = new THREE.MeshBasicMaterial({color:0x00ff00, transparent: true, opacity: .8, side:THREE.DoubleSide});
        caseC.material = new THREE.MeshBasicMaterial({color:0x0000ff, transparent: true, opacity: .8, side:THREE.DoubleSide});
