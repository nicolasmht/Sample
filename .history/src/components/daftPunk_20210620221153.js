        ...
        document.addEventListener('mouseup', () => {
            ...
            let tlRotation = new TimelineMax({})
                ...
                .add(()=> {
                    ...
                    console.log('initialPosition:',initialPosition,'baseRotationTop:',baseRotationTop);
                    console.log('initialPositionIncrement:',(parseFloat(initialPosition)+((Math.PI/2)*faceFind)).toFixed(2),'baseRotationTop:',(baseRotationTop+((Math.PI/2)*faceFind)).toFixed(2));
                    console.log('nextFace:',nextFace);
                    if((initialPosition - (baseRotationTop+((Math.PI/2)*faceFind)).toFixed(2)) == 0 && isComplete == false) {
                        faceFind +=1
                        isComplete=true
                    ...
                    } if(initialPosition - baseRotationTop.toFixed(2) != 0 && isComplete == true) { //turn after find
