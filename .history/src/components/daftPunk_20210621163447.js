...
import interporlate from 'interpolate-range';
...
function DaftPunk(sceneMain, cameraMain, interactionManagerMain) {
    ...
    var render = function () {
        ...
        // pointLight.intensity = interpolate(frequencyData[0]/20);

        pointLight.intensity = interpolate({
            inputRange: [0, frequencyData[0]/20],
            outputRange: [0, 10],
            clamp: true,
        });
