...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        let textureALoad = textureLoader.load(textureA)
        let textureBLoad = textureLoader.load(textureB)
        let textureCLoad = textureLoader.load(textureC)
        let textureDLoad = textureLoader.load(textureD)
        let textureELoad = textureLoader.load(textureE)
        let textureFLoad = textureLoader.load(textureF)
        ...
        .to(caseT.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(caseB.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(etiquette.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(tapeGroup.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(caseB.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(caseT.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(caseObj.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(facade.material, .5, {opacity: 0},0.15) //degage case opacity
        .to(tape.material, .5, {opacity: 0},0.15) //degage case opacity
        Storage_group
scrollTimeline.js:61 case_closed-mobj1
scrollTimeline.js:61 case_tape
scrollTimeline.js:61 case
scrollTimeline.js:61 Case_b_Case_b_elem
scrollTimeline.js:61 Case_t_Case_t_elem
scrollTimeline.js:61 etiquette
scrollTimeline.js:61 Tape
scrollTimeline.js:61 Tape_1
scrollTimeline.js:61 Tape-Mat1
scrollTimeline.js:61 Tape-crome
scrollTimeline.js:61 Tape-glass
scrollTimeline.js:61 Tape-black_plastic
scrollTimeline.js:61 Tape-sticker
scrollTimeline.js:61 Wheel_left
scrollTimeline.js:61 Wheel_right
scrollTimeline.js:61 shelves
scrollTimeline.js:61 desk_haut16
scrollTimeline.js:61 desk_haut
scrollTimeline.js:61 desk_haut2
scrollTimeline.js:61 desk_haut3
scrollTimeline.js:61 flat_tapes
scrollTimeline.js:61 left
scrollTimeline.js:61 right
        ...
        .add(()=> { uniforms.texture1.value = textureALoad },1.75) //blue
        .add(()=> { uniforms.texture2.value = textureBLoad },1.75) //cyan
        ...
        .add(()=> { uniforms.texture2.value = textureBLoad },2.35) //cyan
        .add(()=> { uniforms.texture1.value = textureCLoad },2.35) //prune
        ...
        .add(()=> { uniforms.texture2.value = textureBLoad },2.9) //cyan
        .add(()=> { uniforms.texture2.value = textureDLoad },2.9) //orange
        .to(uniforms.progress, .25, {value: 1},3.15) //fade to texture2
        .add(()=> { uniforms.texture1.value = textureCLoad },3.3) //prune
        ...
        .add(()=> { uniforms.texture2.value = textureDLoad },3.6) //keep orange
        .add(()=> { uniforms.texture1.value = textureELoad },3.6) //change purple
        .to(uniforms.progress, .25, {value: 0},3.85) //fade to texture1
        .add(()=> { uniforms.texture2.value = textureDLoad },4) //keep orange
        ...
        .add(()=> { uniforms.texture1.value = textureELoad },4.65) //keep purple
        .add(()=> { uniforms.texture2.value = textureFLoad },4.65) //change green
