...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        .to(tapeGroup.material, .5, {opacity: 0},1.25) //degage case opacity
        .to(caseB.material, .5, {opacity: 0},1.25) //degage case opacity
        .to(caseT.material, .5, {opacity: 0},1.25) //degage case opacity
        .to(caseObj.material, .5, {opacity: 0},1.25) //degage case opacity
        .to(facade.material, .5, {opacity: 0},1.25) //degage case opacity
        .to(tape.material, .5, {opacity: 0},1.25) //degage case opacity
