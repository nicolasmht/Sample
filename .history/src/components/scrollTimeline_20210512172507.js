...
function ScrollTimeline(scene) {
    ...
    function initTimeline() {
        ...
        // .to(".box", 2, {x:'500px'})
        console.log('hola',object.children[0])
        ...
        .to(object.children[0].material, {emissive : new THREE.Color('rgb(193, 145, 51)')}, 2)
        ...
        window.addEventListener("mousewheel", (e) => {
            ...
            proxyTween.progress(window.pageYOffset/5000).pause();
