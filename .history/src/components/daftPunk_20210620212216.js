            ...
            let tlRotation = new TimelineMax({})
                ...
                .add(()=> {
                    ...
                    if(initialPosition - baseRotationTop.toFixed(2) == 0 && isComplete == false) {
                        isComplete=true
                        tlFusion.to(pyramidT.position, 2, {ease:Bounce.easeIn, y: -1.1}, 0)
                                .to(pyramidT.scale, 2, {ease:Bounce.easeIn, x: 1.25, y:1.25, z:1.25}, 0)
                                .to(pyramid.rotation, 2, {ease:Bounce.easeIn, y: Math.PI}, 2)
