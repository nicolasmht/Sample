...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    const texture = new THREE.TextureLoader().load( 'https://i.ibb.co/b3yXW5z/Moon-001-COLOR.jpg' );
    const geoPlane = new THREE.CircleGeometry( 72, 100 );
    const matPlane = new THREE.MeshStandardMaterial( {color: 0xeeeeee, metalness: 0, roughness: 0.5,transparent: true, opacity: .35, map:texture, side: THREE.DoubleSide} );
