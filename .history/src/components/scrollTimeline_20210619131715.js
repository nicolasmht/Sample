...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        //Base color
        plastic.material = new THREE.MeshBasicMaterial({color:0xD2D4BC, transparent: true, opacity: 1, side:THREE.DoubleSide});
        caseObj.material = new THREE.MeshBasicMaterial({color:0xD2D4BC, transparent: true, opacity: 1, side:THREE.DoubleSide});
        caseB.material = new THREE.MeshBasicMaterial({color:0x00ff00, transparent: true, opacity: 1, side:THREE.DoubleSide});
        caseT.material = new THREE.MeshBasicMaterial({color:0x0000ff, transparent: true, opacity: 1, side:THREE.DoubleSide});
