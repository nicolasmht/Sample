...
function DaftPunk(sceneMain, cameraMain, interactionManagerMain) {
                ...
                setTimeout(()=> {
                    ...
                    switch (faceTarget) {
                        case 'Pyramid_bas_1': //Dog
                                ...
                                soundA.play();
                                player.playSound({title: 'SoundA', artist: 'Dog', date: '1992'})
                            break;
                        case 'Pyramid_bas2': //Spatial
                                console.log('Face 2: SPatial')
                                soundB.play();
                                player.playSound({title: 'SoundB', artist: 'Spatial', date: '1994'})
                            break;
                        case 'Pyramid_bas3': //Hand
                                console.log('Face 3: Hand')
                                soundC.play();
                                player.playSound({title: 'SoundC', artist: 'Hand', date: '1996'})
                            break;
                        case 'Pyramid_bas4': //Phone
                                console.log('Face 4: Phone')
                                soundD.play();
                                player.playSound({title: 'SoundD', artist: 'Phone', date: '1998'})
                            break;
                        default:
                            break;
                    }
                        ...
                        // setTimeout(()=>{
                            ...
                            switch (baseSound) {
                                ...
                                case 1:
                                        ambiantSound1.stop();
                                        ambiantSound2.play();
                                        player.playSound({title: 'SitchB', artist: 'Case2', date: '2002'})
                                    break;
                                case 2:
                                        ambiantSound2.stop();
                                        ambiantSound3.play();
                                        player.playSound({title: 'SitchC', artist: 'Case3', date: '2004'})
                                    break;
                                case 3:
                                        ambiantSound3.stop();
                                        ambiantSound4.play();
                                        player.playSound({title: 'SitchD', artist: 'Case4', date: '2006'})
                                    break;
                                default:
                                    break;
                            }
    ...
    this.start = function() {
        ...
        player = new Player();
        player.playSound({title: 'SitchA', artist: 'Case1', date: '2000'})
