...
import textureA from  '../textures/tape/case1.png'
import textureB from  '../textures/tape/case2.png'
import textureC from  '../textures/tape/case3.png'
import textureD from  '../textures/tape/case4.png'
import textureE from  '../textures/tape/case5.png'
import textureF from  '../textures/tape/case6.png'
...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        let facade = tape.getObjectByName('flat_tapes')//Storage
        let caseObj = tape.getObjectByName('case')
        let tapeObj = tape.getObjectByName('Tape')
        let tapeObj2 = tape.getObjectByName('Tape_1')
        let tapeObj3 = tape.getObjectByName('Tape-Mat1')
        let tapeObj4 = tape.getObjectByName('Tape-black_plastic')
        ...
        caseObj.material = new THREE.MeshBasicMaterial({color:0xff00ff, side:THREE.DoubleSide});
        tapeObj.material = new THREE.MeshBasicMaterial({color:0xff0000, side:THREE.DoubleSide});
        tapeObj2.material = new THREE.MeshBasicMaterial({color:0xff0000, side:THREE.DoubleSide});
        tapeObj3.material = new THREE.MeshBasicMaterial({color:0xff0000, side:THREE.DoubleSide});
        tapeObj4.material = new THREE.MeshBasicMaterial({color:0xffff00, side:THREE.DoubleSide});
        tapeGroup.material = new THREE.MeshBasicMaterial({color:0xffff00, side:THREE.DoubleSide});
