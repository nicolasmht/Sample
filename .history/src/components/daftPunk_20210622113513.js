...
function DaftPunk(sceneMain, cameraMain, interactionManagerMain) {
    ...
    function initInteraction() {
        ...
        document.qurySelector('.focus-daftpunk')addEventListener('mousedown', () => {
            drag = false
            mouseDown = true
        });
        document.qurySelector('.focus-daftpunk')addEventListener('mousemove', (e) => {
            drag = true
            if(mouseDown) {
                if(firstClick) {
        ...
        document.qurySelector('.focus-daftpunk')addEventListener('mouseup', () => {
