...
function ScrollTimeline(scene, camera) {
        ...
        loader.load( TapeModel, ( gltf ) => {
            ...
            tape.traverse( (child) => {
                ...
                switch(modelPart) {
                    ...
                    case 'desk_haut2':
                    case 'desk_haut3':
                        child.material = new THREE.MeshBasicMaterial({color:0xetexturefb0, map: textureCaseLoad, side:THREE.DoubleSide});
                    break;
                    case 'Tape_obj':
    ...
    function initTimeline() {
        ...
        let texture = textureLoader.load(textureC)
        ...
        .add(()=> { uniforms.texture1.value = texture },2.35) //prune
        ...
        .add(()=> { uniforms.texture1.value = texture },3.3) //prune
