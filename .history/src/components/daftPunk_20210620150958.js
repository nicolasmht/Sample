...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    const geometry = new THREE.CircleGeometry( 72, 100 );
    const material = new THREE.MeshStandardMaterial( {color: 0x111111, metalness: 0.5, roughness: 0.5, side: THREE.DoubleSide} );
