...
// Object
import TapeModel from '../objects/AudioTape/case_closed.gltf';
...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        void main() {
            gl_FragColor = vec4( mix( texture2D(texture1, vUv).xyz, texture2D(texture2, vUv).xyz, progress ), inputColor.a );
        }
        `
        let uniforms = {
