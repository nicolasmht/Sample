...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    function initInteraction() {
        ...
        let baseRotationBot = pyramidB.rotation.x;
        let baseRotationTop = pyramidT.rotation.x;
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            if(mouseDown) {
                ...
                dragProgress = targetPyramid.rotation.x
                dragProgress += e.movementX/200;
                targetPyramid.rotation.x = dragProgress;
                let rotationY = targetPyramid.rotation.x - ((Math.PI*2)*turn);
