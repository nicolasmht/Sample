...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        .to(caseObj.position, .5, {x:-2,z:-2},1) //eloignement case x-5
        ...
        //Put back
        .to(caseT.material, .5, {opacity: 1},1.25) //degage case opacity
        .to(caseB.material, .5, {opacity: 1},1.25) //degage case opacity
