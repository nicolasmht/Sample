...
function DaftPunk(sceneMain, cameraMain, interactionManager) {
    ...
    const geometry = new THREE.CircleGeometry( 165, 165 );
    const material = new THREE.MeshStandardMaterial( {color: 0xffff00, metalness: 0, roughness: 0.5, side: THREE.DoubleSide} );
