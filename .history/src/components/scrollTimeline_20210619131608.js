...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        wheelsL.material = new THREE.MeshBasicMaterial({color:0x000000, side:THREE.DoubleSide});
        wheelsR.material = new THREE.MeshBasicMaterial({color:0x000000, side:THREE.DoubleSide});
