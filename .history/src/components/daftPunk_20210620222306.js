        ...
        document.addEventListener('mouseup', () => {
            ...
            let tlRotation = new TimelineMax({})
                ...
                .add(()=> {
                    ...
                    } if((initialPosition - (baseRotationTop+((Math.PI/2)*faceFind)).toFixed(2)) != 0 && isComplete == true) { //turn after find
                        tlFusion.to(pyramidT.position, 1, { y: 2.8129539489746094}, 0)
                                .to(pyramidT.scale, 1, {ease:Bounce.easeIn, x: 1, y:1, z:1}, 0)
                                .to(pyramidT.rotation, 1, {ease:Bounce.easeIn, y:pyramidT.rotation.y + (Math.PI/2)*faceFind}, 0)//turn top pyramid 1time
