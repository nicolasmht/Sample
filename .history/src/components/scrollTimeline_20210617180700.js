...
function ScrollTimeline(scene, camera) {
    ...
    function switchSoundText(dateT, artistT, titleT, dateB, artistB, titleB) {
        document.querySelector('.txt_slider-top').opacity = 0
        document.querySelector('.txt_slider-bot').opacity = 0
        setTimeout(()=> {
            document.querySelector('.txt_slider-top').opacity = 1
            document.querySelector('.txt_slider-bot').opacity = 1
