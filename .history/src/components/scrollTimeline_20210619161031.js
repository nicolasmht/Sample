...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        .to(tapeGroup.rotation, 2, {y:-2.75,x:4}, 4.5) //rotation cassette sur elle meme

        .to(tapeGroup.rotation, 1, {x:-3,y:4.75}, 4.7) //rotation cassette sur elle meme
        .to(tapeGroup.position, 1, {x: 10,y:10, z:0}, 4.7) //decalage cassette position page
