...
function ScrollTimeline(scene, camera) {
    ...
    function initTimeline() {
        ...
        let caseA = tape.getObjectByName('case_closed-mobj1')
        let caseC = tape.getObjectByName('case_tape')
        ...
        //Base color
        plastic.material = new THREE.MeshBasicMaterial({color:0xD2D4BC, transparent: true, opacity: .8, side:THREE.DoubleSide});
        caseObj.material = new THREE.MeshBasicMaterial({color:0xD2D4BC, transparent: true, opacity: .8, side:THREE.DoubleSide});
        caseA.material = new THREE.MeshBasicMaterial({color:0xD2D4BC, transparent: true, opacity: .8, side:THREE.DoubleSide});
        caseB.material = new THREE.MeshBasicMaterial({color:0xD2D4BC, transparent: true, opacity: .8, side:THREE.DoubleSide});
        caseC.material = new THREE.MeshBasicMaterial({color:0xD2D4BC, transparent: true, opacity: .8, side:THREE.DoubleSide});
        ...
        .to(facade.position, 1, {y: 30}, .75) //etagere disapear
        ...
        .to(facade.position, 1, {y: -5.8}, 5.25) //etagere appear bot
        ...
        .to(plastic.material.color, .25, {r:210/255,g:212/255, b:188/255 }, 1.5) //color 1
        .to(plastic.material.color, .25, {r:244/255,g:220/255, b:181/255 }, 1.5) //color 2
        ...
        .to(plastic.material.color, .25, {r:244/255,g:220/255, b:181/255 }, 2.1) //color 2
        .to(plastic.material.color, .25, {r:195/255,g:191/255, b:215/255 }, 2.1) //color 3
        ...
        .to(plastic.material.color, .25, {r:195/255,g:191/255, b:215/255 }, 2.9) //color 3
        .to(plastic.material.color, .25, {r:200/255,g:209/255, b:208/255 }, 2.9) //color 4
        ...
        .to(plastic.material.color, .25, {r:200/255,g:209/255, b:208/255 }, 3.6) //color 4
        .to(plastic.material.color, .25, {r:213/255,g:200/255, b:218/255 }, 3.6) //color 5
