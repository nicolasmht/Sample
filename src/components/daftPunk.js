...
function DaftPunk(sceneMain, cameraMain, interactionManagerMain) {
    ...
    let container = document.querySelector('.focus-daftpunk');
    ...
    function initInteraction() {
        ...
        let mousedown = container.addEventListener('mousedown', () => {
            drag = false
            mouseDown = true
        });
        let mousemove = container.addEventListener('mousemove', (e) => {
            drag = true
            if(mouseDown) {
                if(firstClick) {
        ...
        let mouseup = container.addEventListener('mouseup', () => {
